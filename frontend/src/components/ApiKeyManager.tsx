                    ...
                    <div className="flex items-center">
                      ...
                      {isLargeKey(key.api_key) ? (
                        <button
                          ...
                          className="ml-2 text-blue-400 hover:text-blue-600 p-1 rounded hover:bg-blue-50 transition-colors"
                          title="View full API key details"
                        >
                        ...
                        <button
                          ...
                          className="ml-2 text-gray-400 hover:text-gray-600 p-1 rounded hover:bg-gray-100 transition-colors"
